...
var OptionsView = Backbone.View.extend({
  ...
  template: function(account) {
    ...
    html += '<a href="https://pnut.io/@' + account.username + '" target="_blank">' + account.name + '</a> ';
  ...
  renderAccounts: function() {
    ...
    html += '<br><br><li class="muted" colspan="3">Support for multiple accounts not implemented yet.</li>';
