 ...
 * omnibox events
 */
chrome.omnibox.setDefaultSuggestion({ description: 'Post to pnut.io <match>%s</match>' });
...
function promptAuth() {
  if (accounts.length === 0) {
    var n = new TextNotificationView({
      ...
      body: 'Click to connect your pnut.io account and get started with the awesomeness of Brusque pnut.',
